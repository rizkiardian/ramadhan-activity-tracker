...
@section('title', 'Tambah Tipe Aktivitas — Ramadhan Activity Tracker')
@section('page-title', 'Tambah Tipe Aktivitas')
@section('page-subtitle', 'Buat jenis aktivitas ibadah baru')

@section('content')
  <div class="pt-2 max-w-lg">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      <form method="POST" action="{{ route('activity-types.store') }}" class="space-y-5">
        @csrf
